/*********************************************************************
 *
 * $Id: YGyro.h 23233 2016-02-23 10:43:32Z seb $
 *
 * definition of Qt commandline object
 *
 * - - - - - - - - - License information: - - - - - - - - -
 *
...
#ifndef YOCTO_QT_CMDLINE_H
#define YOCTO_QT_CMDLINE_H
#include "cmdline_common.h"
//--- (generated code: YQt definitions)
class YQtCmdLine : public YFunctionCmdLine {
public:
...
class YGyroCmdLine : public YFunctionCmdLine {
public:
    void RegisterCommands(vector<YapiCommand*>* cmdList);
    string YFunctionName(void);
    bool isModule(void);
