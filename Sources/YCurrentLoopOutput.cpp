/*********************************************************************
 *
 *  $Id: YCurrentLoopOutput.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 ...
 */
class apifun_CurrentLoopOutput_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_CurrentLoopOutput_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
...
void YCurrentLoopOutputCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    ...
    cmdList->push_back((YapiCommand*) (new apifun_CurrentLoopOutput_get_serialNumber(this)));
