/*********************************************************************
 *
 *  $Id: YRangeFinder.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle RangeFinder functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
static const char *enumRangeFinderMode[] = {
    "DEFAULT",
    "LONG_RANGE",
    "HIGH_ACCURACY",
    "HIGH_SPEED",
...
bool   YRangeFinderCmdLine::isModule(void)      { return false; }
string YRangeFinderCmdLine::YFunctionName(void) { return "YRangeFinder"; }
...
// type of rangeFinderMode is int (RangeFinderMode)
// type of hardwareCalibration is string (RangeFinderCalib)
// type of currentTemperature is double (MeasureVal)
// type of command is string (Text)
/**
 * Returns the logical name of the range finder.
 *
 * @return a string corresponding to the logical name of the range finder
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class RangeFinder_get_logicalName : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the range finder.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YRangeFinder*>* list = enumerateTargets<YRangeFinder>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the range finder. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the range finder
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the range finder.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the range finder", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the range finder.
 *
 * @return a string corresponding to a short string representing the current state of the range finder
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class RangeFinder_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the range finder.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the range measured
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class RangeFinder_get_unit : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the range measured.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_unit : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_unit(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_unit";
  }
  ...
  string getDescription()
  {
    return "Changes the measuring unit for the measured range.";
  }

  string getMoreInfo()
  {
    return "That unit is a string. String value can be \" or mm. Any other value is ignored. Remember to call \"YModule {target} saveToFlash\" if the modification must be kept. WARNING: if a specific calibration is defined for the rangeFinder function, a unit system change will probably break it.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the measuring unit for the measured range", "_STRING", false));
    return res;
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the range measured, in mm, as
 * a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class RangeFinder_get_currentValue : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the range measured, in mm, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the range measured
 * since the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class RangeFinder_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the range measured since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the range measured
 * since the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class RangeFinder_get_highestValue : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the range measured since the device was started.";
  }
 ...
 * the sensor, in mm, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class RangeFinder_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in mm, as a floating point number.";
  }
 ...
 */
class RangeFinder_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class RangeFinder_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class RangeFinder_get_advMode : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class RangeFinder_get_resolution : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class RangeFinder_get_sensorState : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class RangeFinder_get_rangeFinderMode : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_rangeFinderMode(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the range finder running mode.";
  }

  string getMoreInfo()
  {
    return "The rangefinder running mode allows you to put priority on precision, speed or maximum range.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        int attrval = (*list)[i]->get_rangeFinderMode();
        string strval =  enumString(attrval,enumRangeFinderMode);
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
};
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class RangeFinder_set_rangeFinderMode : public YapiCommand /* arguments: newval */
{
public:
  RangeFinder_set_rangeFinderMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_rangeFinderMode";
  }

  string getDescription()
  {
    return "Changes the rangefinder running mode, allowing you to put priority onprecision, speed or maximum range.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "a value among DEFAULT, LONG_RANGE, HIGH_ACCURACY and HIGH_SPEED corresponding to the rangefinder running mode, allowing you to put priority on precision, speed or maximum range", "DEFAULT=0,LONG_RANGE=1,HIGH_ACCURACY=2,HIGH_SPEED=3", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_rangeFinderMode(Y_RANGEFINDERMODE_enum((*args)[0]->get_intValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};
 ...
 */
class RangeFinder_get_currentTemperature : public YapiCommand /* arguments: */
{
public:
  RangeFinder_get_currentTemperature(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current sensor temperature, as a floating point number.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        double attrval = (*list)[i]->get_currentTemperature();
        char buf[32]; snprintf(buf,32,"%.3f",attrval); string strval =  string(buf);
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
...
// type of valueCallbackRangeFinder is YRangeFinderValueCallback* (YRangeFinderValueCallback)
// type of timedReportCallbackRangeFinder is YRangeFinderTimedReportCallback* (YRangeFinderTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_RangeFinder_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_RangeFinder_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_RangeFinder_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_RangeFinder_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_RangeFinder_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_RangeFinder_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_RangeFinder_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_RangeFinder_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_RangeFinder_get_hardwareCalibrationTemperature : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_get_hardwareCalibrationTemperature(YFunctionCmdLine *function):YapiCommand(function){}

  string getName()
  {
    return "get_hardwareCalibrationTemperature";
  }

  string getDescription()
  {
    return "Returns the temperature at the time when the latest calibration was performed.";
  }

  string getMoreInfo()
  {
    return "This function can be used to determine if a new calibration for ambient temperature is required.";
  }
  ...
  virtual void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        double value = (*list)[i]->get_hardwareCalibrationTemperature();
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
};
 ...
 *         On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_triggerTemperatureCalibration : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_triggerTemperatureCalibration(YFunctionCmdLine *function):YapiCommand(function){}

  string getName()
  {
    return "triggerTemperatureCalibration";
  }

  string getDescription()
  {
    return "Triggers a sensor calibration according to the current ambient temperature.";
  }

  string getMoreInfo()
  {
    return "That calibration process needs no physical interaction with the sensor. It is performed automatically at device startup, but it is recommended to start it again when the temperature delta since the latest calibration exceeds 8\302\260C.";
  }
  ...
  virtual void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        (*list)[i]->triggerTemperatureCalibration();
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
};
 ...
 *         On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_triggerSpadCalibration : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_triggerSpadCalibration(YFunctionCmdLine *function):YapiCommand(function){}

  string getName()
  {
    return "triggerSpadCalibration";
  }

  string getDescription()
  {
    return "Triggers the photon detector hardware calibration.";
  }

  string getMoreInfo()
  {
    return "This function is part of the calibration procedure to compensate for the the effect of a cover glass. Make sure to read the chapter about hardware calibration for details on the calibration procedure for proper results.";
  }
 ...
 *         On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_triggerOffsetCalibration : public YapiCommand /* arguments: targetDist */
{
public:
  apifun_RangeFinder_triggerOffsetCalibration(YFunctionCmdLine *function):YapiCommand(function){}

  string getName()
  {
    return "triggerOffsetCalibration";
  }

  string getDescription()
  {
    return "Triggers the hardware offset calibration of the distance sensor.";
  }
  ...
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(DOUBLE_ARG, "targetDist", "true distance of the calibration target, in mm or inches, depending on the unit selected in the device", "_DOUBLE", false));
    return res;
  }
  ...
  virtual void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        (*list)[i]->triggerOffsetCalibration((*args)[0]->get_doubleValue());
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
};
 ...
 *         On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_triggerXTalkCalibration : public YapiCommand /* arguments: targetDist */
{
public:
  apifun_RangeFinder_triggerXTalkCalibration(YFunctionCmdLine *function):YapiCommand(function){}

  string getName()
  {
    return "triggerXTalkCalibration";
  }

  string getDescription()
  {
    return "Triggers the hardware cross-talk calibration of the distance sensor.";
  }
  ...
  virtual void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        (*list)[i]->triggerXTalkCalibration((*args)[0]->get_doubleValue());
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
};
 ...
 *         On failure, throws an exception or returns a negative error code.
 */
class apifun_RangeFinder_cancelCoverGlassCalibrations : public YapiCommand /* arguments: */
{
public:
  apifun_RangeFinder_cancelCoverGlassCalibrations(YFunctionCmdLine *function):YapiCommand(function){}

  string getName()
  {
    return "cancelCoverGlassCalibrations";
  }

  string getDescription()
  {
    return "Cancels the effect of previous hardware calibration procedures to compensatefor cover glass, and restores factory settings.";
  }
  ...
  virtual void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        (*list)[i]->cancelCoverGlassCalibrations();
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
};
 ...
 *
 */
class apifun_RangeFinder_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_RangeFinder_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
void YRangeFinderCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YRangeFinder>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_unit(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_rangeFinderMode(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_set_rangeFinderMode(this)));
    cmdList->push_back((YapiCommand*) (new RangeFinder_get_currentTemperature(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_get_hardwareCalibrationTemperature(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_triggerTemperatureCalibration(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_triggerSpadCalibration(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_triggerOffsetCalibration(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_triggerXTalkCalibration(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_cancelCoverGlassCalibrations(this)));
    cmdList->push_back((YapiCommand*) (new apifun_RangeFinder_get_timedReport(this)));
  }
