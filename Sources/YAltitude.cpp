...
bool   YAltitudeCmdLine::isModule(void)      { return false; }
string YAltitudeCmdLine::YFunctionName(void) { return "YAltitude"; }
...
// type of qnh is double (MeasureVal)
// type of technology is string (Text)
/**
 * Returns the logical name of the altimeter.
 *
 * @return a string corresponding to the logical name of the altimeter
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class Altitude_get_logicalName : public YapiCommand /* arguments: */
{
public:
  Altitude_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the altimeter.";
  }
...
/**
 * Changes the logical name of the altimeter. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the altimeter
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the altimeter.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the altimeter", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the altimeter.
 *
 * @return a string corresponding to a short string representing the current state of the altimeter
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class Altitude_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  Altitude_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the altimeter.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the altitude
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class Altitude_get_unit : public YapiCommand /* arguments: */
{
public:
  Altitude_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the altitude.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_currentValue : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the current estimated altitude.";
  }
  ...
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(DOUBLE_ARG, "newval", "a floating point number corresponding to the current estimated altitude", "_DOUBLE", false));
    return res;
  }
 ...
 */
class Altitude_get_currentValue : public YapiCommand /* arguments: */
{
public:
  Altitude_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the altitude since
 * the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class Altitude_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  Altitude_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the altitude since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the altitude since
 * the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class Altitude_get_highestValue : public YapiCommand /* arguments: */
{
public:
  Altitude_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the altitude since the device was started.";
  }
 ...
 * the sensor, in meters, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class Altitude_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  Altitude_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in meters, as a floating point number.";
  }
 ...
 */
class Altitude_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  Altitude_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Altitude_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  Altitude_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Altitude_get_advMode : public YapiCommand /* arguments: */
{
public:
  Altitude_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Altitude_get_resolution : public YapiCommand /* arguments: */
{
public:
  Altitude_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Altitude_get_sensorState : public YapiCommand /* arguments: */
{
public:
  Altitude_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Altitude_set_qnh : public YapiCommand /* arguments: newval */
{
public:
  Altitude_set_qnh(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_qnh";
  }
  ...
  string getDescription()
  {
    return "Changes the barometric pressure adjusted to sea level used to computethe altitude (QNH).";
  }

  string getMoreInfo()
  {
    return "This enables you to compensate for atmospheric pressure changes due to weather conditions. Applicable to barometric altimeters only.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(DOUBLE_ARG, "newval", "a floating point number corresponding to the barometric pressure adjusted to sea level used to compute the altitude (QNH)", "_DOUBLE", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_qnh(double((*args)[0]->get_doubleValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};
 ...
 */
class Altitude_get_qnh : public YapiCommand /* arguments: */
{
public:
  Altitude_get_qnh(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the barometric pressure adjusted to sea level used to computethe altitude (QNH).";
  }

  string getMoreInfo()
  {
    return "Applicable to barometric altimeters only.";
  }
 ...
 */
class Altitude_get_technology : public YapiCommand /* arguments: */
{
public:
  Altitude_get_technology(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the technology used by the sesnor to computealtitude.";
  }

  string getMoreInfo()
  {
    return "Possibles values are \"barometric\" and \"gps\"";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        string attrval = (*list)[i]->get_technology();
        string strval =  attrval;
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
...
// type of valueCallbackAltitude is YAltitudeValueCallback* (YAltitudeValueCallback)
// type of timedReportCallbackAltitude is YAltitudeTimedReportCallback* (YAltitudeTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Altitude_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Altitude_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Altitude_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Altitude_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Altitude_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_Altitude_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Altitude_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Altitude_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Altitude_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Altitude_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Altitude_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_Altitude_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Altitude_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Altitude_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Altitude_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Altitude_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_Altitude_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_Altitude_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
//--- (YAltitude functions)
void YAltitudeCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YAltitude>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Altitude_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_set_qnh(this)));
    cmdList->push_back((YapiCommand*) (new Altitude_get_qnh(this)));
    ...
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Altitude_get_timedReport(this)));
  }
