/*********************************************************************
 *
 *  $Id: YAccelerometer.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle Accelerometer functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YAccelerometerCmdLine::isModule(void)      { return false; }
string YAccelerometerCmdLine::YFunctionName(void) { return "YAccelerometer"; }
...
// type of gravityCancellation is int (OnOff)
/**
 * Returns the logical name of the accelerometer.
 *
 * @return a string corresponding to the logical name of the accelerometer
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class Accelerometer_get_logicalName : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the accelerometer.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YAccelerometer*>* list = enumerateTargets<YAccelerometer>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the accelerometer. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the accelerometer
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the accelerometer.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the accelerometer", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the accelerometer.
 *
 * @return a string corresponding to a short string representing the current state of the accelerometer
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class Accelerometer_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the accelerometer.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the acceleration
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class Accelerometer_get_unit : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the acceleration.";
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the acceleration, in g, as a
 * floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class Accelerometer_get_currentValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the acceleration, in g, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the acceleration
 * since the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class Accelerometer_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the acceleration since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the acceleration
 * since the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class Accelerometer_get_highestValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the acceleration since the device was started.";
  }
 ...
 * the sensor, in g, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class Accelerometer_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in g, as a floating point number.";
  }
 ...
 */
class Accelerometer_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Accelerometer_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Accelerometer_get_advMode : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Accelerometer_get_resolution : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Accelerometer_get_sensorState : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Accelerometer_get_bandwidth : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_bandwidth(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Accelerometer_set_bandwidth : public YapiCommand /* arguments: newval */
{
public:
  Accelerometer_set_bandwidth(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Accelerometer_get_xValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_xValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the X component of the acceleration, as a floating point number.";
  }
 ...
 */
class Accelerometer_get_yValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_yValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the Y component of the acceleration, as a floating point number.";
  }
 ...
 */
class Accelerometer_get_zValue : public YapiCommand /* arguments: */
{
public:
  Accelerometer_get_zValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the Z component of the acceleration, as a floating point number.";
  }
...
// type of valueCallbackAccelerometer is YAccelerometerValueCallback* (YAccelerometerValueCallback)
// type of timedReportCallbackAccelerometer is YAccelerometerTimedReportCallback* (YAccelerometerTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Accelerometer_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Accelerometer_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Accelerometer_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Accelerometer_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Accelerometer_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Accelerometer_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Accelerometer_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_Accelerometer_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Accelerometer_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Accelerometer_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Accelerometer_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Accelerometer_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Accelerometer_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_Accelerometer_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Accelerometer_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Accelerometer_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Accelerometer_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Accelerometer_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_Accelerometer_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_Accelerometer_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
void YAccelerometerCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YAccelerometer>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_bandwidth(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_set_bandwidth(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_xValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_yValue(this)));
    cmdList->push_back((YapiCommand*) (new Accelerometer_get_zValue(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Accelerometer_get_timedReport(this)));
  }
