...
static const char *enumReadiness[] = {
    "DOWN",
    "EXISTS",
    "LINKED",
    "LAN_OK",
...
static const char *enumHTTPMethod[] = {
    "POST",
    "GET",
    "PUT",
    NULL
...
static const char *enumCallbackEncoding[] = {
    "FORM",
    "JSON",
    "JSON_ARRAY",
    "CSV",
...
bool   YNetworkCmdLine::isModule(void)      { return false; }
string YNetworkCmdLine::YFunctionName(void) { return "YNetwork"; }
...
// type of callbackInitialDelay is int (UInt31)
// type of callbackSchedule is string (CallbackSchedule)
...
{
public:
  Network_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_get_readiness(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_get_macAddress(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_get_ipAddress(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_get_subnetMask(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_get_router(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Network_get_ipConfig : public YapiCommand /* arguments: */
{
public:
  Network_get_ipConfig(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        string attrval = (*list)[i]->get_ipConfig();
        string strval =  attrval;
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
...
{
public:
  Network_get_primaryDNS(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_primaryDNS(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_secondaryDNS(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_secondaryDNS(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_ntpServer(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_ntpServer(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_userPassword(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_userPassword(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_adminPassword(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_adminPassword(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_httpPort(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_httpPort(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_httpPort";
  }
  ...
  string getMoreInfo()
  {
    return "If not value are set the hub return \"index.html\" which is the web interface of the hub. It is possible to change this page for file that has been uploaded on the hub.";
  }
...
{
public:
  Network_get_defaultPage(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_defaultPage(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_discoverable(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_discoverable(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_wwwWatchdogDelay(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_wwwWatchdogDelay(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_callbackUrl(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_callbackUrl(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_callbackMethod(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_callbackMethod(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Network_get_callbackEncoding(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_callbackEncoding(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "a value among FORM, JSON, JSON_ARRAY, CSV, YOCTO_API, JSON_NUM, EMONCMS, AZURE, INFLUXDB, MQTT, YOCTO_API_JZON and PRTG corresponding to the encoding standard to use for representing notification values", "FORM=0,JSON=1,JSON_ARRAY=2,CSV=3,YOCTO_API=4,JSON_NUM=5,EMONCMS=6,AZURE=7,INFLUXDB=8,MQTT=9,YOCTO_API_JZON=10,PRTG=11", false));
    return res;
  }
...
{
public:
  Network_get_callbackCredentials(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Network_set_callbackCredentials(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  alias_Network_callbackLogin(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Network_get_callbackInitialDelay : public YapiCommand /* arguments: */
{
public:
  Network_get_callbackInitialDelay(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the initial waiting time before first callback notifications, in seconds.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        int attrval = (*list)[i]->get_callbackInitialDelay();
        char buf[32]; snprintf(buf, 32,"%d", attrval); string strval =  string(buf);
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Network_set_callbackInitialDelay : public YapiCommand /* arguments: newval */
{
public:
  Network_set_callbackInitialDelay(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_callbackInitialDelay";
  }

  string getDescription()
  {
    return "Changes the initial waiting time before first callback notifications, in seconds.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "an integer corresponding to the initial waiting time before first callback notifications, in seconds", "_INT", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_callbackInitialDelay(int((*args)[0]->get_intValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};
 ...
 */
class Network_get_callbackSchedule : public YapiCommand /* arguments: */
{
public:
  Network_get_callbackSchedule(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the HTTP callback schedule strategy, as a text string.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        string attrval = (*list)[i]->get_callbackSchedule();
        string strval =  attrval;
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Network_set_callbackSchedule : public YapiCommand /* arguments: newval */
{
public:
  Network_set_callbackSchedule(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_callbackSchedule";
  }

  string getDescription()
  {
    return "Changes the HTTP callback schedule strategy, as a text string.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the HTTP callback schedule strategy, as a text string", "_STRING", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_callbackSchedule(string((*args)[0]->get_stringValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};
...
{
public:
  Network_get_callbackMinDelay(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimum waiting time between two HTTP callbacks, in seconds.";
  }
...
{
public:
  Network_set_callbackMinDelay(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the minimum waiting time between two HTTP callbacks, in seconds.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "an integer corresponding to the minimum waiting time between two HTTP callbacks, in seconds", "_INT", false));
    return res;
  }
...
{
public:
  Network_get_callbackMaxDelay(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the waiting time between two HTTP callbacks when there is nothing new.";
  }
...
{
public:
  Network_set_callbackMaxDelay(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the waiting time between two HTTP callbacks when there is nothing new.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "an integer corresponding to the waiting time between two HTTP callbacks when there is nothing new", "_INT", false));
    return res;
  }
...
{
public:
  Network_get_poeCurrent(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current consumed by the module from Power-over-Ethernet (PoE), in milliamps.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Network_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Network_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Network_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Network_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Network_useDHCP(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(INT_ARG, "fallbackSubnetMaskLen", "fallback subnet mask length when no DHCP reply is received, as an integer (e.g. 24 means 255.255.255.0)", "_INT", false));
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Network_useDHCPauto : public YapiCommand /* arguments: */
{
public:
  apifun_Network_useDHCPauto(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getMoreInfo()
  {
    return "Until an address is received from a DHCP server, the module uses an IP of the network 169.254.0.0/16 (APIPA). Remember to call the saveToFlash() method and then to reboot the module to apply this setting.";
  }
...
{
public:
  apifun_Network_useStaticIP(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(INT_ARG, "subnetMaskLen", "subnet mask length, as an integer (e.g. 24 means 255.255.255.0)", "_INT", false));
...
{
public:
  apifun_Network_ping(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Pings host to test the network connectivity.";
  }

  string getMoreInfo()
  {
    return "Sends four ICMP ECHO_REQUEST requests from the module to the target host. This method returns a string with the result of the 4 ICMP ECHO_REQUEST requests.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Network_triggerCallback : public YapiCommand /* arguments: */
{
public:
  apifun_Network_triggerCallback(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Trigger an HTTP callback quickly.";
  }

  string getMoreInfo()
  {
    return "This function can even be called within an HTTP callback, in which case the next callback will be triggered 5 seconds after the end of the current callback, regardless if the minimum time between callbacks configured in the device.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Network_set_periodicCallbackSchedule : public YapiCommand /* arguments: interval offset */
{
public:
  apifun_Network_set_periodicCallbackSchedule(YFunctionCmdLine *function):YapiCommand(function){}

  string getName()
  {
    return "set_periodicCallbackSchedule";
  }

  string getDescription()
  {
    return "Setup periodic HTTP callbacks (simplified function).";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(STRING_ARG, "interval", "a string representing the callback periodicity, expressed in seconds, minutes or hours, eg. \"60s\", \"5m\", \"1h\", \"48h\".", "_STRING", false));
    res->push_back(new ArgumentDesc(INT_ARG, "offset", "an integer representing the time offset relative to the period when the callback should occur. For instance, if the periodicity is 24h, an offset of 7 will make the callback occur each day at 7AM.", "_INT", false));
    return res;
  }
  ...
  virtual void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        (*list)[i]->set_periodicCallbackSchedule((*args)[0]->get_stringValue(),
                                                 (int)(*args)[1]->get_intValue());
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
...
//--- (YNetwork functions)
void YNetworkCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YNetwork>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Network_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_readiness(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_macAddress(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_ipAddress(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_subnetMask(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_router(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_ipConfig(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_primaryDNS(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_primaryDNS(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_secondaryDNS(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_secondaryDNS(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_ntpServer(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_ntpServer(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_userPassword(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_userPassword(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_adminPassword(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_adminPassword(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_httpPort(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_httpPort(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_defaultPage(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_defaultPage(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_discoverable(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_discoverable(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_wwwWatchdogDelay(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_wwwWatchdogDelay(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackUrl(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackUrl(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackMethod(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackMethod(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackEncoding(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackEncoding(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackCredentials(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackCredentials(this)));
    cmdList->push_back((YapiCommand*) (new alias_Network_callbackLogin(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackInitialDelay(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackInitialDelay(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackSchedule(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackSchedule(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackMinDelay(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackMinDelay(this)));
    cmdList->push_back((YapiCommand*) (new Network_get_callbackMaxDelay(this)));
    cmdList->push_back((YapiCommand*) (new Network_set_callbackMaxDelay(this)));
    ...
    cmdList->push_back((YapiCommand*) (new apifun_Network_ping(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Network_triggerCallback(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Network_set_periodicCallbackSchedule(this)));
  }
