/*********************************************************************
 *
 *  $Id: YPower.cpp 33903 2018-12-28 08:49:26Z seb $
 *
...
bool   YPowerCmdLine::isModule(void)      { return false; }
string YPowerCmdLine::YFunctionName(void) { return "YPower"; }
...
{
public:
  Power_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    vector<YPower*>* list = enumerateTargets<YPower>(_function, target, modulelist);
    unsigned int i;
...
{
public:
  Power_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Power_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Power_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Power_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Power_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Power_get_advMode : public YapiCommand /* arguments: */
{
public:
  Power_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Power_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Power_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
...
{
public:
  Power_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  Power_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_cosPhi(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_meter(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  Power_get_meterTimer(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Power_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Power_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Power_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Power_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Power_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Power_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_reset(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  apifun_Power_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
//--- (YPower functions)
void YPowerCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YPower>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Power_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Power_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Power_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Power_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Power_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Power_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Power_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Power_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_cosPhi(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_meter(this)));
    cmdList->push_back((YapiCommand*) (new Power_get_meterTimer(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_reset(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Power_get_timedReport(this)));
  }
