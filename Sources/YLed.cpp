/*********************************************************************
 *
 *  $Id: YLed.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 ...
 */
class apifun_Led_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Led_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
...
void YLedCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    ...
    cmdList->push_back((YapiCommand*) (new apifun_Led_get_serialNumber(this)));
  }
