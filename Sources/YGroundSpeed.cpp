/*********************************************************************
 *
 *  $Id: YGroundSpeed.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle GroundSpeed functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YGroundSpeedCmdLine::isModule(void)      { return false; }
string YGroundSpeedCmdLine::YFunctionName(void) { return "YGroundSpeed"; }
 ...
 *
 * @return a string corresponding to the logical name of the ground speed sensor
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class GroundSpeed_get_logicalName : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the ground speed sensor.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YGroundSpeed*>* list = enumerateTargets<YGroundSpeed>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the ground speed sensor. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the ground speed sensor
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class GroundSpeed_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  GroundSpeed_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the ground speed sensor.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the ground speed sensor", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the ground speed sensor.
 *
 * @return a string corresponding to a short string representing the current state of the ground speed sensor
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class GroundSpeed_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the ground speed sensor.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the ground speed
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class GroundSpeed_get_unit : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the ground speed.";
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the ground speed, in km/h, as
 * a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class GroundSpeed_get_currentValue : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the ground speed, in km/h, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class GroundSpeed_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  GroundSpeed_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the ground speed
 * since the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class GroundSpeed_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the ground speed since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class GroundSpeed_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  GroundSpeed_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the ground speed
 * since the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class GroundSpeed_get_highestValue : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the ground speed since the device was started.";
  }
 ...
 * the sensor, in km/h, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class GroundSpeed_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in km/h, as a floating point number.";
  }
 ...
 */
class GroundSpeed_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class GroundSpeed_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  GroundSpeed_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class GroundSpeed_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class GroundSpeed_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  GroundSpeed_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class GroundSpeed_get_advMode : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class GroundSpeed_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  GroundSpeed_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class GroundSpeed_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  GroundSpeed_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class GroundSpeed_get_resolution : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class GroundSpeed_get_sensorState : public YapiCommand /* arguments: */
{
public:
  GroundSpeed_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
...
// type of valueCallbackGroundSpeed is YGroundSpeedValueCallback* (YGroundSpeedValueCallback)
// type of timedReportCallbackGroundSpeed is YGroundSpeedTimedReportCallback* (YGroundSpeedTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_GroundSpeed_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_GroundSpeed_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_GroundSpeed_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_GroundSpeed_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_GroundSpeed_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_GroundSpeed_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_GroundSpeed_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_GroundSpeed_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_GroundSpeed_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_GroundSpeed_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_GroundSpeed_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_GroundSpeed_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_GroundSpeed_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_GroundSpeed_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_GroundSpeed_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_GroundSpeed_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_GroundSpeed_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_GroundSpeed_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_GroundSpeed_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_GroundSpeed_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
void YGroundSpeedCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YGroundSpeed>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new GroundSpeed_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_GroundSpeed_get_timedReport(this)));
  }
