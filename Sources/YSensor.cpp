/*********************************************************************
 *
 * $Id: YSensor.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 ...
 */
class apifun_Sensor_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Sensor_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
...
void YSensorCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    ...
    cmdList->push_back((YapiCommand*) (new apifun_Sensor_get_serialNumber(this)));
