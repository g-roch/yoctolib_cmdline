/*********************************************************************
 *
 *  $Id: YAudioIn.cpp 33903 2018-12-28 08:49:26Z seb $
 *
...
bool   YAudioInCmdLine::isModule(void)      { return false; }
string YAudioInCmdLine::YFunctionName(void) { return "YAudioIn"; }
...
{
public:
  AudioIn_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    vector<YAudioIn*>* list = enumerateTargets<YAudioIn>(_function, target, modulelist);
    unsigned int i;
...
{
public:
  AudioIn_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
{
public:
  AudioIn_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  AudioIn_get_volume(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  AudioIn_set_volume(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_volume";
  }
...
{
public:
  AudioIn_get_mute(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  AudioIn_set_mute(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_mute";
  }
...
{
public:
  AudioIn_get_volumeRange(YFunctionCmdLine *function):YapiCommand(function){}
...
{
public:
  AudioIn_get_signal(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class AudioIn_get_noSignalFor : public YapiCommand /* arguments: */
{
public:
  AudioIn_get_noSignalFor(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_AudioIn_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_AudioIn_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_AudioIn_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_AudioIn_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_AudioIn_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_AudioIn_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
...
//--- (YAudioIn functions)
void YAudioInCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YAudioIn>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new AudioIn_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_get_volume(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_set_volume(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_get_mute(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_set_mute(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_get_volumeRange(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_get_signal(this)));
    cmdList->push_back((YapiCommand*) (new AudioIn_get_noSignalFor(this)));
    cmdList->push_back((YapiCommand*) (new apifun_AudioIn_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_AudioIn_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_AudioIn_get_serialNumber(this)));
  }
