/*********************************************************************
 *
 *  $Id: YMultiCellWeighScale.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle MultiCellWeighScale functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YMultiCellWeighScaleCmdLine::isModule(void)      { return false; }
string YMultiCellWeighScaleCmdLine::YFunctionName(void) { return "YMultiCellWeighScale"; }
...
// type of cellCount is int (UInt31)
...
/**
 * Returns the logical name of the multi-cell weighing scale sensor.
 *
 * @return a string corresponding to the logical name of the multi-cell weighing scale sensor
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class MultiCellWeighScale_get_logicalName : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the multi-cell weighing scale sensor.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YMultiCellWeighScale*>* list = enumerateTargets<YMultiCellWeighScale>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the multi-cell weighing scale sensor. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the multi-cell weighing scale sensor
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the multi-cell weighing scale sensor.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the multi-cell weighing scale sensor", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the multi-cell weighing scale sensor.
 *
 * @return a string corresponding to a short string representing the current state of the multi-cell
 * weighing scale sensor
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class MultiCellWeighScale_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the multi-cell weighing scale sensor.";
  }
 ...
 */
class MultiCellWeighScale_get_unit : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_unit : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_unit(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_unit";
  }
 ...
 */
class MultiCellWeighScale_get_currentValue : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_highestValue : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class MultiCellWeighScale_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class MultiCellWeighScale_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_advMode : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_resolution : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class MultiCellWeighScale_get_sensorState : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class MultiCellWeighScale_get_cellCount : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_cellCount(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the number of load cells in use.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        int attrval = (*list)[i]->get_cellCount();
        char buf[32]; snprintf(buf, 32,"%d", attrval); string strval =  string(buf);
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_cellCount : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_cellCount(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_cellCount";
  }

  string getDescription()
  {
    return "Changes the number of load cells in use.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "an integer corresponding to the number of load cells in use", "_INT", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_cellCount(int((*args)[0]->get_intValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};
 ...
 */
class MultiCellWeighScale_get_excitation : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_excitation(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_excitation : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_excitation(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_tempAvgAdaptRatio : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_tempAvgAdaptRatio(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_tempAvgAdaptRatio : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_tempAvgAdaptRatio(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_tempChgAdaptRatio : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_tempChgAdaptRatio(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_tempChgAdaptRatio : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_tempChgAdaptRatio(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class MultiCellWeighScale_get_compTempAvg : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_compTempAvg(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class MultiCellWeighScale_get_compTempChg : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_compTempChg(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class MultiCellWeighScale_get_compensation : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_compensation(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class MultiCellWeighScale_set_zeroTracking : public YapiCommand /* arguments: newval */
{
public:
  MultiCellWeighScale_set_zeroTracking(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class MultiCellWeighScale_get_zeroTracking : public YapiCommand /* arguments: */
{
public:
  MultiCellWeighScale_get_zeroTracking(YFunctionCmdLine *function):YapiCommand(function){}
...
// type of valueCallbackMultiCellWeighScale is YMultiCellWeighScaleValueCallback* (YMultiCellWeighScaleValueCallback)
// type of timedReportCallbackMultiCellWeighScale is YMultiCellWeighScaleTimedReportCallback* (YMultiCellWeighScaleTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_MultiCellWeighScale_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_MultiCellWeighScale_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_MultiCellWeighScale_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_MultiCellWeighScale_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_MultiCellWeighScale_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_MultiCellWeighScale_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_MultiCellWeighScale_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_MultiCellWeighScale_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_MultiCellWeighScale_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_MultiCellWeighScale_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_MultiCellWeighScale_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_MultiCellWeighScale_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_MultiCellWeighScale_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_MultiCellWeighScale_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_MultiCellWeighScale_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_MultiCellWeighScale_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_MultiCellWeighScale_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_MultiCellWeighScale_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_MultiCellWeighScale_tare : public YapiCommand /* arguments: */
{
public:
  apifun_MultiCellWeighScale_tare(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_MultiCellWeighScale_setupSpan : public YapiCommand /* arguments: currWeight maxWeight */
{
public:
  apifun_MultiCellWeighScale_setupSpan(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Configures the load cells span parameters (stored in the corresponding genericSensors)so that the current signal corresponds to the specified reference weight.";
  }
 ...
 *
 */
class apifun_MultiCellWeighScale_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_MultiCellWeighScale_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
void YMultiCellWeighScaleCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YMultiCellWeighScale>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_unit(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_cellCount(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_cellCount(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_excitation(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_excitation(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_tempAvgAdaptRatio(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_tempAvgAdaptRatio(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_tempChgAdaptRatio(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_tempChgAdaptRatio(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_compTempAvg(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_compTempChg(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_compensation(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_set_zeroTracking(this)));
    cmdList->push_back((YapiCommand*) (new MultiCellWeighScale_get_zeroTracking(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_tare(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_setupSpan(this)));
    cmdList->push_back((YapiCommand*) (new apifun_MultiCellWeighScale_get_timedReport(this)));
  }
