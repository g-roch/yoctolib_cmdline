/*********************************************************************
 *
 *  $Id: YLongitude.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle Longitude functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YLongitudeCmdLine::isModule(void)      { return false; }
string YLongitudeCmdLine::YFunctionName(void) { return "YLongitude"; }
 ...
 *
 * @return a string corresponding to the logical name of the longitude sensor
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class Longitude_get_logicalName : public YapiCommand /* arguments: */
{
public:
  Longitude_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the longitude sensor.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YLongitude*>* list = enumerateTargets<YLongitude>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the longitude sensor. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the longitude sensor
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class Longitude_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  Longitude_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the longitude sensor.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the longitude sensor", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the longitude sensor.
 *
 * @return a string corresponding to a short string representing the current state of the longitude sensor
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class Longitude_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  Longitude_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the longitude sensor.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the longitude
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class Longitude_get_unit : public YapiCommand /* arguments: */
{
public:
  Longitude_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the longitude.";
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the longitude, in deg/1000,
 * as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class Longitude_get_currentValue : public YapiCommand /* arguments: */
{
public:
  Longitude_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the longitude, in deg/1000, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Longitude_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  Longitude_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the longitude since
 * the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class Longitude_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  Longitude_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the longitude since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Longitude_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  Longitude_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the longitude since
 * the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class Longitude_get_highestValue : public YapiCommand /* arguments: */
{
public:
  Longitude_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the longitude since the device was started.";
  }
 ...
 * the sensor, in deg/1000, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class Longitude_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  Longitude_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in deg/1000, as a floating point number.";
  }
 ...
 */
class Longitude_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  Longitude_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Longitude_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  Longitude_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Longitude_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  Longitude_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Longitude_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  Longitude_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Longitude_get_advMode : public YapiCommand /* arguments: */
{
public:
  Longitude_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Longitude_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Longitude_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Longitude_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  Longitude_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Longitude_get_resolution : public YapiCommand /* arguments: */
{
public:
  Longitude_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Longitude_get_sensorState : public YapiCommand /* arguments: */
{
public:
  Longitude_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
...
// type of valueCallbackLongitude is YLongitudeValueCallback* (YLongitudeValueCallback)
// type of timedReportCallbackLongitude is YLongitudeTimedReportCallback* (YLongitudeTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Longitude_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Longitude_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Longitude_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Longitude_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Longitude_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Longitude_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Longitude_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_Longitude_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Longitude_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Longitude_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Longitude_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Longitude_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Longitude_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_Longitude_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Longitude_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Longitude_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Longitude_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Longitude_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_Longitude_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_Longitude_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
void YLongitudeCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YLongitude>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Longitude_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Longitude_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Longitude_get_timedReport(this)));
  }
