/*********************************************************************
 *
 *  $Id: YVoltage.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle Voltage functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YVoltageCmdLine::isModule(void)      { return false; }
string YVoltageCmdLine::YFunctionName(void) { return "YVoltage"; }
 ...
 */
class Voltage_get_logicalName : public YapiCommand /* arguments: */
{
public:
  Voltage_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the voltage sensor.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YVoltage*>* list = enumerateTargets<YVoltage>(_function, target, modulelist);
    unsigned int i;
 ...
 */
class Voltage_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  Voltage_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the voltage sensor.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the voltage sensor", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the voltage sensor.
 *
 * @return a string corresponding to a short string representing the current state of the voltage sensor
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class Voltage_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  Voltage_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the voltage sensor.";
  }
 ...
 */
class Voltage_get_unit : public YapiCommand /* arguments: */
{
public:
  Voltage_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the voltage.";
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the voltage, in Volt, as a
 * floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class Voltage_get_currentValue : public YapiCommand /* arguments: */
{
public:
  Voltage_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the voltage, in Volt, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Voltage_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  Voltage_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the voltage since
 * the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class Voltage_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  Voltage_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the voltage since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Voltage_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  Voltage_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the voltage since
 * the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class Voltage_get_highestValue : public YapiCommand /* arguments: */
{
public:
  Voltage_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the voltage since the device was started.";
  }
 ...
 * the sensor, in Volt, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class Voltage_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  Voltage_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in Volt, as a floating point number.";
  }
 ...
 */
class Voltage_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  Voltage_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Voltage_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  Voltage_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Voltage_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  Voltage_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Voltage_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  Voltage_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Voltage_get_advMode : public YapiCommand /* arguments: */
{
public:
  Voltage_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Voltage_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Voltage_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Voltage_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  Voltage_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Voltage_get_resolution : public YapiCommand /* arguments: */
{
public:
  Voltage_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Voltage_get_sensorState : public YapiCommand /* arguments: */
{
public:
  Voltage_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
...
// type of valueCallbackVoltage is YVoltageValueCallback* (YVoltageValueCallback)
// type of timedReportCallbackVoltage is YVoltageTimedReportCallback* (YVoltageTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Voltage_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Voltage_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Voltage_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Voltage_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Voltage_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Voltage_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Voltage_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_Voltage_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Voltage_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Voltage_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Voltage_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Voltage_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Voltage_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_Voltage_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Voltage_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Voltage_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Voltage_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Voltage_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_Voltage_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_Voltage_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
//--- (YVoltage functions)
void YVoltageCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YVoltage>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Voltage_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Voltage_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Voltage_get_timedReport(this)));
  }
