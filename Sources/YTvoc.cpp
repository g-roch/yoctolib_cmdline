/*********************************************************************
 *
 *  $Id: YTvoc.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle Tvoc functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YTvocCmdLine::isModule(void)      { return false; }
string YTvocCmdLine::YFunctionName(void) { return "YTvoc"; }
...
/**
 * Returns the logical name of the Total  Volatile Organic Compound sensor.
 *
 * @return a string corresponding to the logical name of the Total  Volatile Organic Compound sensor
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class Tvoc_get_logicalName : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the Total Volatile Organic Compound sensor.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YTvoc*>* list = enumerateTargets<YTvoc>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the Total  Volatile Organic Compound sensor. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the Total  Volatile Organic Compound sensor
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class Tvoc_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  Tvoc_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the Total Volatile Organic Compound sensor.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the Total Volatile Organic Compound sensor", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the Total  Volatile Organic Compound sensor.
 *
 * @return a string corresponding to a short string representing the current state of the Total 
 * Volatile Organic Compound sensor
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class Tvoc_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the Total Volatile Organic Compound sensor.";
  }
...
/**
 * Returns the measuring unit for the estimated TVOC concentration.
 *
 * @return a string corresponding to the measuring unit for the estimated TVOC concentration
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class Tvoc_get_unit : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the estimated TVOC concentration.";
  }
...
/**
 * Returns the current value of the estimated TVOC concentration, in ppb, as a floating point number.
 ...
 *
 * @return a floating point number corresponding to the current value of the estimated TVOC
 * concentration, in ppb, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class Tvoc_get_currentValue : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the estimated TVOC concentration, in ppb, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tvoc_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  Tvoc_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
/**
 * Returns the minimal value observed for the estimated TVOC concentration since the device was started.
 * Can be reset to an arbitrary value thanks to set_lowestValue().
 *
 * @return a floating point number corresponding to the minimal value observed for the estimated TVOC
 * concentration since the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class Tvoc_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the estimated TVOC concentration since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tvoc_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  Tvoc_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
/**
 * Returns the maximal value observed for the estimated TVOC concentration since the device was started.
 * Can be reset to an arbitrary value thanks to set_highestValue().
 *
 * @return a floating point number corresponding to the maximal value observed for the estimated TVOC
 * concentration since the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class Tvoc_get_highestValue : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the estimated TVOC concentration since the device was started.";
  }
...
/**
 * Returns the uncalibrated, unrounded raw value returned by the sensor, in ppb, as a floating point number.
 *
 * @return a floating point number corresponding to the uncalibrated, unrounded raw value returned by
 * the sensor, in ppb, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class Tvoc_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in ppb, as a floating point number.";
  }
 ...
 */
class Tvoc_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tvoc_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  Tvoc_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Tvoc_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tvoc_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  Tvoc_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Tvoc_get_advMode : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tvoc_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Tvoc_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tvoc_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  Tvoc_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Tvoc_get_resolution : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Tvoc_get_sensorState : public YapiCommand /* arguments: */
{
public:
  Tvoc_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
...
// type of valueCallbackTvoc is YTvocValueCallback* (YTvocValueCallback)
// type of timedReportCallbackTvoc is YTvocTimedReportCallback* (YTvocTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tvoc_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Tvoc_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tvoc_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Tvoc_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Tvoc_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Tvoc_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Tvoc_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_Tvoc_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Tvoc_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Tvoc_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Tvoc_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Tvoc_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Tvoc_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_Tvoc_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tvoc_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Tvoc_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tvoc_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Tvoc_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_Tvoc_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_Tvoc_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
//--- (YTvoc functions)
void YTvocCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YTvoc>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Tvoc_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Tvoc_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tvoc_get_timedReport(this)));
  }
