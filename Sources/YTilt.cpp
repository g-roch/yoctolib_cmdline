/*********************************************************************
 *
 *  $Id: YTilt.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle Tilt functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YTiltCmdLine::isModule(void)      { return false; }
string YTiltCmdLine::YFunctionName(void) { return "YTilt"; }
 ...
 *
 * @return a string corresponding to the logical name of the tilt sensor
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class Tilt_get_logicalName : public YapiCommand /* arguments: */
{
public:
  Tilt_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the tilt sensor.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YTilt*>* list = enumerateTargets<YTilt>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the tilt sensor. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the tilt sensor
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the tilt sensor.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the tilt sensor", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the tilt sensor.
 *
 * @return a string corresponding to a short string representing the current state of the tilt sensor
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class Tilt_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  Tilt_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the tilt sensor.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the inclination
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class Tilt_get_unit : public YapiCommand /* arguments: */
{
public:
  Tilt_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the inclination.";
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the inclination, in degrees,
 * as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class Tilt_get_currentValue : public YapiCommand /* arguments: */
{
public:
  Tilt_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the inclination, in degrees, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the inclination
 * since the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class Tilt_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  Tilt_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the inclination since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the inclination
 * since the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class Tilt_get_highestValue : public YapiCommand /* arguments: */
{
public:
  Tilt_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the inclination since the device was started.";
  }
 ...
 */
class Tilt_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  Tilt_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Tilt_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  Tilt_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Tilt_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  Tilt_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Tilt_get_advMode : public YapiCommand /* arguments: */
{
public:
  Tilt_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Tilt_get_resolution : public YapiCommand /* arguments: */
{
public:
  Tilt_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Tilt_get_sensorState : public YapiCommand /* arguments: */
{
public:
  Tilt_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Tilt_get_bandwidth : public YapiCommand /* arguments: */
{
public:
  Tilt_get_bandwidth(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Tilt_set_bandwidth : public YapiCommand /* arguments: newval */
{
public:
  Tilt_set_bandwidth(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
...
// type of valueCallbackTilt is YTiltValueCallback* (YTiltValueCallback)
// type of timedReportCallbackTilt is YTiltTimedReportCallback* (YTiltTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tilt_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Tilt_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tilt_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Tilt_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Tilt_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Tilt_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Tilt_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_Tilt_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Tilt_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Tilt_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Tilt_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Tilt_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Tilt_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_Tilt_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tilt_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Tilt_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Tilt_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Tilt_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_Tilt_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_Tilt_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
//--- (YTilt functions)
void YTiltCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YTilt>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Tilt_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_get_bandwidth(this)));
    cmdList->push_back((YapiCommand*) (new Tilt_set_bandwidth(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Tilt_get_timedReport(this)));
  }
