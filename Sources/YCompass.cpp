/*********************************************************************
 *
 *  $Id: YCompass.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle Compass functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YCompassCmdLine::isModule(void)      { return false; }
string YCompassCmdLine::YFunctionName(void) { return "YCompass"; }
...
// type of axis is int (Axis)
// type of magneticHeading is double (MeasureVal)
/**
 * Returns the logical name of the compass.
 *
 * @return a string corresponding to the logical name of the compass
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class Compass_get_logicalName : public YapiCommand /* arguments: */
{
public:
  Compass_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the compass.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YCompass*>* list = enumerateTargets<YCompass>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the compass. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the compass
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the compass.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the compass", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the compass.
 *
 * @return a string corresponding to a short string representing the current state of the compass
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class Compass_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  Compass_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the compass.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the relative bearing
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class Compass_get_unit : public YapiCommand /* arguments: */
{
public:
  Compass_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the relative bearing.";
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the relative bearing, in
 * degrees, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class Compass_get_currentValue : public YapiCommand /* arguments: */
{
public:
  Compass_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the relative bearing, in degrees, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the relative
 * bearing since the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class Compass_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  Compass_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the relative bearing since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the relative
 * bearing since the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class Compass_get_highestValue : public YapiCommand /* arguments: */
{
public:
  Compass_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the relative bearing since the device was started.";
  }
 ...
 * the sensor, in degrees, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class Compass_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  Compass_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in degrees, as a floating point number.";
  }
 ...
 */
class Compass_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  Compass_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Compass_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  Compass_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Compass_get_advMode : public YapiCommand /* arguments: */
{
public:
  Compass_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Compass_get_resolution : public YapiCommand /* arguments: */
{
public:
  Compass_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Compass_get_sensorState : public YapiCommand /* arguments: */
{
public:
  Compass_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class Compass_get_bandwidth : public YapiCommand /* arguments: */
{
public:
  Compass_get_bandwidth(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class Compass_set_bandwidth : public YapiCommand /* arguments: newval */
{
public:
  Compass_set_bandwidth(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class Compass_get_magneticHeading : public YapiCommand /* arguments: */
{
public:
  Compass_get_magneticHeading(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the magnetic heading, regardless of the configured bearing.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        double attrval = (*list)[i]->get_magneticHeading();
        char buf[32]; snprintf(buf,32,"%.3f",attrval); string strval =  string(buf);
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
...
// type of valueCallbackCompass is YCompassValueCallback* (YCompassValueCallback)
// type of timedReportCallbackCompass is YCompassTimedReportCallback* (YCompassTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Compass_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Compass_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Compass_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_Compass_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Compass_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_Compass_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Compass_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_Compass_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Compass_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Compass_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_Compass_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_Compass_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_Compass_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_Compass_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Compass_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Compass_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_Compass_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_Compass_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_Compass_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_Compass_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
//--- (YCompass functions)
void YCompassCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YCompass>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new Compass_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_bandwidth(this)));
    cmdList->push_back((YapiCommand*) (new Compass_set_bandwidth(this)));
    cmdList->push_back((YapiCommand*) (new Compass_get_magneticHeading(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_Compass_get_timedReport(this)));
  }
