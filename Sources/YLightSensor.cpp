/*********************************************************************
 *
 *  $Id: YLightSensor.cpp 33821 2018-12-21 13:57:06Z seb $
 *
 *  Implements commands to handle LightSensor functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
static const char *enumLightSensorTypeAll[] = {
    "HUMAN_EYE",
    "WIDE_SPECTRUM",
    "INFRARED",
    "HIGH_RATE",
...
bool   YLightSensorCmdLine::isModule(void)      { return false; }
string YLightSensorCmdLine::YFunctionName(void) { return "YLightSensor"; }
...
// type of measureType is int (LightSensorTypeAll)
/**
 ...
 */
class LightSensor_get_logicalName : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the light sensor.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YLightSensor*>* list = enumerateTargets<YLightSensor>(_function, target, modulelist);
    unsigned int i;
 ...
 */
class LightSensor_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the light sensor.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the light sensor", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the light sensor.
 *
 * @return a string corresponding to a short string representing the current state of the light sensor
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class LightSensor_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the light sensor.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the ambient light
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class LightSensor_get_unit : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the ambient light.";
  }
 ...
 *
 * @return a floating point number corresponding to the current value of the ambient light, in the
 * specified unit, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class LightSensor_get_currentValue : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the ambient light, in the specified unit, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class alias_LightSensor_calibrate : public YapiCommand /* arguments: calibratedVal */
{
public:
  alias_LightSensor_calibrate(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Changes the sensor-specific calibration parameter so that the current valuematches a desired target (linear scaling).";
  }
  ...
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(DOUBLE_ARG, "calibratedVal", "the desired target value.", "_DOUBLE", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        (*list)[i]->calibrate((*args)[0]->get_doubleValue());
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
      }
  }
};
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class LightSensor_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the ambient light
 * since the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class LightSensor_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the ambient light since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class LightSensor_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the ambient light
 * since the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class LightSensor_get_highestValue : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the ambient light since the device was started.";
  }
 ...
 */
class LightSensor_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class LightSensor_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class LightSensor_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class LightSensor_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class LightSensor_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class LightSensor_get_advMode : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class LightSensor_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class LightSensor_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class LightSensor_get_resolution : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class LightSensor_get_sensorState : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class LightSensor_get_measureType : public YapiCommand /* arguments: */
{
public:
  LightSensor_get_measureType(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the type of light measure.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        int attrval = (*list)[i]->get_measureType();
        string strval =  enumString(attrval,enumLightSensorTypeAll);
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), strval, true);
      }
  }
};
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class LightSensor_set_measureType : public YapiCommand /* arguments: newval */
{
public:
  LightSensor_set_measureType(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_measureType";
  }

  string getDescription()
  {
    return "Changes the light sensor type used in the device.";
  }

  string getMoreInfo()
  {
    return "The measure can either approximate the response of the human eye, focus on a specific light spectrum, depending on the capabilities of the light-sensitive cell. Remember to call \"YModule {target} saveToFlash\" if the modification must be kept.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "a value among HUMAN_EYE, WIDE_SPECTRUM, INFRARED, HIGH_RATE and HIGH_ENERGY corresponding to the light sensor type used in the device", "HUMAN_EYE=0,WIDE_SPECTRUM=1,INFRARED=2,HIGH_RATE=3,HIGH_ENERGY=4", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_measureType(Y_MEASURETYPE_enum((*args)[0]->get_intValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};

// type of valueCallbackLightSensor is YLightSensorValueCallback* (YLightSensorValueCallback)
// type of timedReportCallbackLightSensor is YLightSensorTimedReportCallback* (YLightSensorTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_LightSensor_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_LightSensor_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_LightSensor_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_LightSensor_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_LightSensor_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_LightSensor_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_LightSensor_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_LightSensor_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_LightSensor_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_LightSensor_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_LightSensor_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_LightSensor_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_LightSensor_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_LightSensor_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_LightSensor_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_LightSensor_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_LightSensor_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_LightSensor_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
void YLightSensorCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YLightSensor>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new LightSensor_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new alias_LightSensor_calibrate(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_get_measureType(this)));
    cmdList->push_back((YapiCommand*) (new LightSensor_set_measureType(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_get_timedReport(this)));
  }
