/*********************************************************************
 *
 *  $Id: YLightSensor.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 ...
 */
class apifun_LightSensor_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_LightSensor_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
...
void YLightSensorCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    ...
    cmdList->push_back((YapiCommand*) (new apifun_LightSensor_get_serialNumber(this)));
