/*********************************************************************
 *
 *  $Id: YQuadratureDecoder.cpp 33903 2018-12-28 08:49:26Z seb $
 *
 *  Implements commands to handle QuadratureDecoder functions
 *
 *  - - - - - - - - - License information: - - - - - - - - -
 *
...
bool   YQuadratureDecoderCmdLine::isModule(void)      { return false; }
string YQuadratureDecoderCmdLine::YFunctionName(void) { return "YQuadratureDecoder"; }
...
// type of decoding is int (OnOff)
/**
 * Returns the logical name of the quadrature decoder.
 *
 * @return a string corresponding to the logical name of the quadrature decoder
 *
 * On failure, throws an exception or returns Y_LOGICALNAME_INVALID.
 */
class QuadratureDecoder_get_logicalName : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  {
    return "Returns the logical name of the quadrature decoder.";
  }

  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    vector<YQuadratureDecoder*>* list = enumerateTargets<YQuadratureDecoder>(_function, target, modulelist);
    unsigned int i;
...
/**
 * Changes the logical name of the quadrature decoder. You can use yCheckLogicalName()
 * prior to this call to make sure that your parameter is valid.
 * Remember to call the saveToFlash() method of the module if the
 * modification must be kept.
 *
 * @param newval : a string corresponding to the logical name of the quadrature decoder
 *
 * @return YAPI_SUCCESS if the call succeeds.
 *
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_logicalName : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_logicalName(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
  ...
  string getDescription()
  {
    return "Changes the logical name of the quadrature decoder.";
  }
  ...
  vector<ArgumentDesc*>* getArgumentDesc()
  {
    ...
    res->push_back(new ArgumentDesc(STRING_ARG, "newval", "a string corresponding to the logical name of the quadrature decoder", "_LOGICAL", false));
    return res;
  }
...
/**
 * Returns a short string representing the current state of the quadrature decoder.
 *
 * @return a string corresponding to a short string representing the current state of the quadrature decoder
 *
 * On failure, throws an exception or returns Y_ADVERTISEDVALUE_INVALID.
 */
class QuadratureDecoder_get_advertisedValue : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_advertisedValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns a short string representing the current state of the quadrature decoder.";
  }
 ...
 *
 * @return a string corresponding to the measuring unit for the position
 *
 * On failure, throws an exception or returns Y_UNIT_INVALID.
 */
class QuadratureDecoder_get_unit : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_unit(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the measuring unit for the position.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_currentValue : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_currentValue";
  }

  string getDescription()
  {
    return "Changes the current expected position of the quadrature decoder.";
  }

  string getMoreInfo()
  {
    return "Invoking this function implicitly activates the quadrature decoder.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(DOUBLE_ARG, "newval", "a floating point number corresponding to the current expected position of the quadrature decoder", "_DOUBLE", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_currentValue(double((*args)[0]->get_doubleValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};
 ...
 *
 * @return a floating point number corresponding to the current value of the position, in pas, as a
 * floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTVALUE_INVALID.
 */
class QuadratureDecoder_get_currentValue : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_currentValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current value of the position, in pas, as a floating point number.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_lowestValue : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the minimal value observed for the position since
 * the device was started
 *
 * On failure, throws an exception or returns Y_LOWESTVALUE_INVALID.
 */
class QuadratureDecoder_get_lowestValue : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_lowestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the minimal value observed for the position since the device was started.";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_highestValue : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 *
 * @return a floating point number corresponding to the maximal value observed for the position since
 * the device was started
 *
 * On failure, throws an exception or returns Y_HIGHESTVALUE_INVALID.
 */
class QuadratureDecoder_get_highestValue : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_highestValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the maximal value observed for the position since the device was started.";
  }
 ...
 * the sensor, in pas, as a floating point number
 *
 * On failure, throws an exception or returns Y_CURRENTRAWVALUE_INVALID.
 */
class QuadratureDecoder_get_currentRawValue : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_currentRawValue(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the uncalibrated, unrounded raw value returned by the sensor, in pas, as a floating point number.";
  }
 ...
 */
class QuadratureDecoder_get_logFrequency : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_logFrequency : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_logFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class QuadratureDecoder_get_reportFrequency : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_reportFrequency : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_reportFrequency(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class QuadratureDecoder_get_advMode : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_advMode(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_advMode : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_advMode(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_advMode";
  }
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_resolution : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_resolution(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
 ...
 */
class QuadratureDecoder_get_resolution : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_resolution(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class QuadratureDecoder_get_sensorState : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_sensorState(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class QuadratureDecoder_get_speed : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_speed(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the increments frequency, in Hz.";
  }
 ...
 */
class QuadratureDecoder_get_decoding : public YapiCommand /* arguments: */
{
public:
  QuadratureDecoder_get_decoding(YFunctionCmdLine *function):YapiCommand(function){}
  ...
  string getDescription()
  {
    return "Returns the current activation state of the quadrature decoder.";
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches )
  {
    ...
    for (i = 0; i < list->size(); i++)
      {
        int attrval = (*list)[i]->get_decoding();
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class QuadratureDecoder_set_decoding : public YapiCommand /* arguments: newval */
{
public:
  QuadratureDecoder_set_decoding(YFunctionCmdLine *function):YapiCommand(function){}
  string getName()
  {
    return "set_decoding";
  }
  ...
  string getDescription()
  {
    return "Changes the activation state of the quadrature decoder.";
  }

  vector<ArgumentDesc*>* getArgumentDesc()
  {
    vector<ArgumentDesc*>* res = new vector<ArgumentDesc*>();
    res->push_back(new ArgumentDesc(INT_ARG, "newval", "either OFF or ON, according to the activation state of the quadrature decoder", "OFF=0,ON=1", false));
    return res;
  }
  ...
  void execute(string target, vector<YModule*> *modulelist, string resultformat, vector<ArgumentDesc*>* args, vector<SwitchDesc*>* switches)
  {
    ...
    string value = (*args)[0]->to_str();
    for (i = 0; i < list->size(); i++) {
        (*list)[i]->set_decoding(Y_DECODING_enum((*args)[0]->get_intValue()));
        PrintResult(resultformat, this->getName(),YFunctionInfoCache((*list)[i]), value, true);
    }
  }
};

// type of valueCallbackQuadratureDecoder is YQuadratureDecoderValueCallback* (YQuadratureDecoderValueCallback)
// type of timedReportCallbackQuadratureDecoder is YQuadratureDecoderTimedReportCallback* (YQuadratureDecoderTimedReportCallback)
/**
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_QuadratureDecoder_muteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_QuadratureDecoder_muteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_QuadratureDecoder_unmuteValueCallbacks : public YapiCommand /* arguments: */
{
public:
  apifun_QuadratureDecoder_unmuteValueCallbacks(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_QuadratureDecoder_get_serialNumber : public YapiCommand /* arguments: */
{
public:
  apifun_QuadratureDecoder_get_serialNumber(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_QuadratureDecoder_isSensorReady : public YapiCommand /* arguments: */
{
public:
  apifun_QuadratureDecoder_isSensorReady(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_QuadratureDecoder_startDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_QuadratureDecoder_startDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * @return YAPI_SUCCESS if the call succeeds.
 */
class apifun_QuadratureDecoder_stopDataLogger : public YapiCommand /* arguments: */
{
public:
  apifun_QuadratureDecoder_stopDataLogger(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 */
class apifun_QuadratureDecoder_get_recordedData : public YapiCommand /* arguments: startTime endTime */
{
public:
  apifun_QuadratureDecoder_get_recordedData(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_QuadratureDecoder_calibrateFromPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_QuadratureDecoder_calibrateFromPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 * On failure, throws an exception or returns a negative error code.
 */
class apifun_QuadratureDecoder_loadCalibrationPoints : public YapiCommand /* arguments: rawValues refValues */
{
public:
  apifun_QuadratureDecoder_loadCalibrationPoints(YFunctionCmdLine *function):YapiCommand(function){}
 ...
 *
 */
class apifun_QuadratureDecoder_get_timedReport : public YapiCommand /* arguments: minWait maxWait */
{
public:
  apifun_QuadratureDecoder_get_timedReport(YFunctionCmdLine *function):YapiCommand(function){}
...
void YQuadratureDecoderCmdLine::RegisterCommands(vector<YapiCommand*>* cmdList)
  {
    RegisterGenericFunctions<YQuadratureDecoder>(this, cmdList);
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_logicalName(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_advertisedValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_unit(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_currentValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_lowestValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_highestValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_currentRawValue(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_logFrequency(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_reportFrequency(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_advMode(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_advMode(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_resolution(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_resolution(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_sensorState(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_speed(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_get_decoding(this)));
    cmdList->push_back((YapiCommand*) (new QuadratureDecoder_set_decoding(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_muteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_unmuteValueCallbacks(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_get_serialNumber(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_isSensorReady(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_startDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_stopDataLogger(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_get_recordedData(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_calibrateFromPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_loadCalibrationPoints(this)));
    cmdList->push_back((YapiCommand*) (new apifun_QuadratureDecoder_get_timedReport(this)));
  }
